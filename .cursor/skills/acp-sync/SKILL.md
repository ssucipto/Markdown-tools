...
# ACP Command: /acp-sync

Execute ACP Enhanced command `/acp-sync`.

1. Read and follow **every step** in `agent/commands/acp.sync.md`.
...
**Canonical source**: `agent/commands/acp.sync.md`
**Equivalent invocations**: `/acp-sync`, `@acp-sync`, `@agent/commands/acp.sync.md`
