...
# ACP Command: /acp-plan

Execute ACP Enhanced command `/acp-plan`.

1. Read and follow **every step** in `agent/commands/acp.plan.md`.
...
**Canonical source**: `agent/commands/acp.plan.md`
**Equivalent invocations**: `/acp-plan`, `@acp-plan`, `@agent/commands/acp.plan.md`
