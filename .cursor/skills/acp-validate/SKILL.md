...
# ACP Command: /acp-validate

Execute ACP Enhanced command `/acp-validate`.

1. Read and follow **every step** in `agent/commands/acp.validate.md`.
...
**Canonical source**: `agent/commands/acp.validate.md`
**Equivalent invocations**: `/acp-validate`, `@acp-validate`, `@agent/commands/acp.validate.md`
