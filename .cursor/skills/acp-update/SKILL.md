...
# ACP Command: /acp-update

Execute ACP Enhanced command `/acp-update`.

1. Read and follow **every step** in `agent/commands/acp.update.md`.
...
**Canonical source**: `agent/commands/acp.update.md`
**Equivalent invocations**: `/acp-update`, `@acp-update`, `@agent/commands/acp.update.md`
