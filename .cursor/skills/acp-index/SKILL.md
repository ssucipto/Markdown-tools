...
# ACP Command: /acp-index

Execute ACP Enhanced command `/acp-index`.

1. Read and follow **every step** in `agent/commands/acp.index.md`.
...
**Canonical source**: `agent/commands/acp.index.md`
**Equivalent invocations**: `/acp-index`, `@acp-index`, `@agent/commands/acp.index.md`
