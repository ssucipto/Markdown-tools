...
# ACP Command: /acp-report

Execute ACP Enhanced command `/acp-report`.

1. Read and follow **every step** in `agent/commands/acp.report.md`.
...
**Canonical source**: `agent/commands/acp.report.md`
**Equivalent invocations**: `/acp-report`, `@acp-report`, `@agent/commands/acp.report.md`
